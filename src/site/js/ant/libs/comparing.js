...
$(function() {
	...
	$("#comparing-sort").width(	$("#comparing-sort li").length * 156);
	
	$(".slider-left").click(function () {
		 $(".comparing-list .item-list").animate({ scrollLeft: $(".comparing-list .item-list").scrollLeft() - 153 }, 500 );
		//$(".comparing-list .item-list").animate({ scrollLeft: 0 }, 500 );
		return false;
	});
	$(".slider-rigth").click(function () {
		$(".comparing-list .item-list").animate({ scrollLeft: $(".comparing-list .item-list").scrollLeft() + 153 }, 500 );
		return false;
	});
});
