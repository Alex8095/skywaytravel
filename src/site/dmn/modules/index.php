...
$title = 'Управление блоком &#8220;Модули&#8221;';
$helpInfo = "";
...
<form id="myForm" action="" method="post">
  <div class="eventForm"> <a href="#" class="ui-state-default ui-corner-all bottom-padding" title="добавить модуль" id="submitAdd"><span class="ui-icon ui-icon-plus"></span>добавить модуль</a> <a href="#" class="ui-state-default ui-corner-all bottom-padding" title="редактировать модуль" id="submitEdit"><span class="ui-icon ui-icon-pencil"></span>редактировать модуль</a> <a href="#" class="ui-state-default ui-corner-all bottom-padding" title="удалить модуль" id="submitDell"><span class="ui-icon ui-icon-trash"></span>удалить модуль</a>
    <div class="clean"> </div>
  </div>
