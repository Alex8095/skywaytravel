...
<form action="template.data.retention.php" id='userForm' class="zpFormWinXP" method="POST">
      ...
      <fieldset>
          ...
          <input class='zpForm' value="" size="40" maxlength="105" name="page_url" type="text" >
          <br />
          <label class='zpFormLabel'>Текст Url страницы</label>
          <input class='zpForm' value="" size="40" maxlength="105" name="page_url_text" type="text" >
          <br />
      ...
      <fieldset>
		    ...
		    <input class='zpForm' value="pc_text" size="13" name="pc_type" type="hidden"/>
		    <br />
	  </fieldset>
