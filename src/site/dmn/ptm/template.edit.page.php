...
$clSelContent = new mysql_select('pages_content', "WHERE lang_id = $_COOKIE[lang_id] and page_id  = '{$_POST['page_id']}'");
$clSelContent->select_table ("pc_id");
$Content = "";

if($clSelContent->table)
$Content = $clSelContent->table[0];
