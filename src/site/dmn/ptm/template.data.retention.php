...
if ($_POST ['retention'] == 'edit_page') {
	try {
		$arr_update = array ("parent_id" => "'{$_POST[parent_id]}',", "hide" => ($_POST ['hide'] ? $_POST ['hide'] : "NULL") . ",", "is_cache" => ($_POST ['is_cache'] ? $_POST ['is_cache'] : "NULL") . ",", "p_type" => "'{$_POST[p_type]}',", "p_w_menu" => "'{$_POST[p_w_menu]}',", "p_w_title" => "'{$_POST[p_w_title]}',", "p_w_keyw" => "'{$_POST[p_w_keyw]}',", "p_w_desc" => "'{$_POST[p_w_desc]}',", "p_level" => ($_POST ['p_level'] ? $_POST ['p_level'] : "NULL") . ",", "pos" => "{$_POST[pos]}" );
		...
		$arr_update = array ("pc_text" => "'" . mysql_real_escape_string($_POST[pc_text]) ."'" );
