...
<input class='zpForm' value="<?php echo $active_id ['ct_url'];?>" size="40" name="ct_url" type="text"> <br />
</fieldset>
...
<br />
<input class='zpForm' value="4fb2962473de2" size="13" name="dict_id" type="hidden"> 
