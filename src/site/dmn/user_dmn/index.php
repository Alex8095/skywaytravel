...
define ( 'SLASH', '../../' );
  ...
  $pageinfo = '<p class=help>Здесь можно добавлять, редактировать и удалять &#8220;Администраторов сайта&#8221;.</p>';
...
<form  id="myForm" action="" method="post">   
    <div class="eventForm">
	 	<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="добавить администратора" id="submitAdd"><span class="ui-icon ui-icon-plus"></span>добавить администратора</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="редактировать администратора" id="submitEdit"><span class="ui-icon ui-icon-pencil"></span>редактировать администратора</a>
		<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="удалить администратора" id="submitDell"><span class="ui-icon ui-icon-trash"></span>удалить администратора</a>
	</div>
