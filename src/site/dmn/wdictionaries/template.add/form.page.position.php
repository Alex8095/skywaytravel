...
Zapatec.Form.setupAll({
	...
	asyncSubmitFunc: AddDictPosIsOk,
	busyConfig: {
...
function AddDictPosIsOk () {
	...
	$('#errOutput').text('');
	$('#errOutput').show();
	$("#errOutput").append('Добавление значения справочника выполнено успешно.');
...
<fieldset><label class='zpFormLabel'>ID позиции</label> <input
	class='zpForm' value="" size="13" name="dict_id" type="text"> <br />
<label class='zpFormLabel'>Код позиции</label> <input class='zpForm'
	value="" size="40" name="dict_code" type="text"> <br />
<label class='zpFormLabel'>Значение позиции</label> <input
	class='zpFormRequired' value="" size="40" name="dict_name" type="text">
<br />
...
<label class='zpFormLabel'>Родитель</label> <select name="parent_id"
	...
	<label class='zpFormLabel'>Позиция</label>
 	<input class='zpForm' value="" size="40" name="pos" type="text"> <br />
<input class='zpForm' value="add_position_page" size="13"
	name="retention" type="hidden"> <br />
</fieldset>
