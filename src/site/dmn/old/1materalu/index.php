...
$title = 'Управление блоком &laquo;Материалы&raquo;';
...
<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="добавить пункт" id="submitAdd"><span class="ui-icon ui-icon-plus"></span>добавить пункт</a> 
<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="редактировать пункт" id="submitEdit"><span class="ui-icon ui-icon-pencil"></span>редактировать пункт</a> 
<a href="#" class="ui-state-default ui-corner-all bottom-padding" title="удалить пункт" id="submitDell"><span class="ui-icon ui-icon-trash"></span>удалить пункт</a></div>
