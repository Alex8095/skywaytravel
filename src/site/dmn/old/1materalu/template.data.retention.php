...
$ImgPropLogo ['ImgW'] = 300;
$ImgPropLogo ['ImgH'] = 200;
$ImgProp ['ImgW'] = 300;
$ImgProp ['ImgH'] = 200;
...
if ($_POST ['retention'] == 'edit_cat') {
	try {
		...
		$arr_update = array ("parent_id" => "'{$_POST[parent_id]}',", "ct_name" => "'{$_POST[ct_name]}',", "ct_url" => "'{$_POST[ct_url]}',",  "ct_adress" => "'{$_POST[ct_adress]}',", "ct_text" => "'{$_POST[ct_text]}',", "dict_id" => "'{$_POST[dict_id]}',", "hide" => "{$_POST[hide]},", "pos" => "{$_POST[pos]}" );
