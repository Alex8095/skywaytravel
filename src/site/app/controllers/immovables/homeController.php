...
class homeController extends aControllerClass {
	...
	public function rent($param) {
		...
		$model->getListPager ( $param, $param["page_id"], "/home/rent" );
		$this->buildImmovablesHttpHead ( $param, $model, "home", "rent" );
	...
	public function sale($param) {
		...
		$param["hide"] = "show";
		$model = new immovablesModelClass ( new immovablesProviderClass ( "immovables", "im_id" ) );
		$model->getListPager ( $param, $param["page_id"], "/home/sale" );
		$this->buildImmovablesHttpHead ( $param, $model, "home", "sale" );
		return $this->View ( array(
				"Model" => $model) );
	}
