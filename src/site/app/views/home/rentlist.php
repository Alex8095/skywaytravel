...
// 				$area = $city;
		...
		<div class="item colomns i-<?php echo $value["im_id"]; ?>">
			<div class="colomn w-200 img">
				...
				<a href="/home/rent/<?php echo $routingObj->getParamItem("page_id", 1);?>/<?php echo $value["im_id"]; ?>" title="<?php echo $im_title;?>"><img src="<?php echo getLangString('imageDomain');?>/files/images/immovables/si_<?php echo $value["im_photo"];?>" width="180" alt="<?php echo $im_title;?>"/></a>
				<div class="colomns">
					<?php if($value["photos"]): ?>
			...
			<div class="colomn info">
				...
				<div class="colomns ">
					<div class="colomn w-160">
						<?php if($area): ?>
							<a href="/home/rent/<?php echo $routingObj->getParamItem("page_id", 1);?>?<?php echo  $m->urlDictToParent($value["im_area_id"])?>&action=ImFormSearch" title="<?php echo $area;?> район" class="city-area"><?php echo $area;?> район</a>
						<?php elseif ($city): ?>	
							<a href="/home/rent/<?php echo $routingObj->getParamItem("page_id", 1);?>?<?php echo  $m->urlDictToParent($value["im_city_id"], 2)?>&action=ImFormSearch" title="<?php echo $city;?>" class="city-area"><?php echo $city;?></a>
						<?php endif;?>
						<div class="clear"></div>
						<a href="/home/rent/<?php echo $routingObj->getParamItem("page_id", 1);?>/<?php echo $value["im_id"]; ?>" title="<?php echo $im_title;?>"  class="im-code"><?php echo getLangString('ImFListHeaderCodeN');?>: <?php echo $value["im_code"];?></a>
					</div>
				...
				<div class="buttoms">
					<a href="/home/rent/<?php echo $routingObj->getParamItem("page_id", 1);?>/<?php echo $value["im_id"]; ?>" title="<?php echo $im_title;?>" class="readmore"><span class="bg-icons">&nbsp;</span><?php echo getLangString('imReadMore');?></a>
					<a target="_blank" href="/home/rent/<?php echo $routingObj->getParamItem("page_id", 1);?>/<?php echo $value["im_id"]; ?>" title="<?php echo $im_title;?>" class="readmoreblank"><span class="bg-icons">&nbsp;</span><?php echo getLangString('imReadMoreBlank');?></a>
                    <a href="/home/rent/<?php echo $routingObj->getParamItem("page_id", 1);?>/<?php echo $value["im_id"]; ?>#map" title="<?php echo $im_title;?>" class="map"><span class="bg-icons">&nbsp;</span><?php echo getLangString('imReadMoreMap');?></a>
