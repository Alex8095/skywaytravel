	...
	<table cellpadding="0" cellspacing="0" border="0" class="list_Flat_table_block search_list_table">
		...
		<?php foreach ($Model->list as $key => $value):?>
			<tr>
				...
				<td class="ListTableImIndexImg"><a href="/<?php echo $arWords["TypeCatImNameArrIdPAge"][$value["im_catalog_id"]]; ?>/<?php echo ($value["im_is_sale"] ? "sale" : "rent");?>/1/<?php echo $value["im_id"];?>"><img src="<?php echo getLangString('imageDomain');?>/files/images/immovables/st_<?php echo $value["im_photo"];?>" alt="<?php echo $value["im_title"];?>"/></a></td>
				<td class="TdListLeftAlight"><p><?php echo $value["im_title"];?></p><p><b><?php echo $m->GetFullAdress($value, "im_full_adress")?></b></p><div class="ImPropTable"><?php echo $m->GetPropListValue($value, "im_prop_list")?></div><a class="AReadMore" href="/<?php echo $arWords["TypeCatImNameArrIdPAge"][$value["im_catalog_id"]]; ?>/<?php echo ($value["im_is_sale"] ? "sale" : "rent");?>/1/<?php echo $value["im_id"]; ?>"><?php echo getLangString(REadMore);?></a></td>
				...
				<td>
					<?php if($value["im_is_sale"]):?>
						<a href="/<?php echo $arWords["TypeCatImNameArrIdPAge"][$value["im_catalog_id"]]; ?>/<?php echo ($value["im_is_sale"] ? "sale" : "rent");?>/1/<?php echo $value["im_id"]; ?>"><img title="Продажа" alt="Продажа" class="ImPriceUpImg" src="<?php echo getLangString('imageDomain');?>/files/images/bg/sale_im.png"></a>
					<?php endif;?>
					<?php if($value["im_is_rent"]):?>
						<a href="/<?php echo $arWords["TypeCatImNameArrIdPAge"][$value["im_catalog_id"]]; ?>/<?php echo ($value["im_is_sale"] ? "sale" : "rent");?>/1/<?php echo $value["im_id"]; ?>"><img title="Продажа" alt="Продажа" class="ImPriceUpImg" src="<?php echo getLangString('imageDomain');?>/files/images/bg/rent_im.png"></a>
					<?php endif;?>	
				</td>
			    <td class="TdListRightBorder"><a href="/<?php echo $arWords["TypeCatImNameArrIdPAge"][$value["im_catalog_id"]]; ?>/<?php echo ($value["im_is_sale"] ? "sale" : "rent");?>/1/<?php echo $value["im_id"]; ?>#YMapsID"><?php echo appHtmlClass::partial("immovables/ymap/image", array("Model"=>$Model, "item" => $value, "m" => $m) );?></a></td>	
        	</tr>	
		<?php endforeach;?>
	</table>												
<?php else:?>
