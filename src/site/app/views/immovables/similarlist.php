...
if($Model->list) {
	...
	$im_similar_arr_h = appHtmlClass::partial("immovables/listminiinline", array("Model"=> $Model));
}
$paramForGet = $paramAll;
...
if($Model->list) {
	...
	$Model->getPropertiesList ( $paramAll );
	unset($paramAll["im_ids"]);
	$im_similar_str_h = appHtmlClass::partial("immovables/listminiinline", array("Model"=> $Model));
}
$paramForGet = $paramAll;
unset($paramForGet["im_area_id"]);
unset($paramForGet["im_adress_id"]);
...
if($Model->list) {
	...
	$Model->getPropertiesList ( $paramAll );
	unset($paramAll["im_ids"]);
	$im_similar_spa_h = appHtmlClass::partial("immovables/listminiinline", array("Model"=> $Model));
}
$paramForGet = $paramAll;
unset($paramForGet["im_area_id"]);
unset($paramForGet["im_adress_id"]);
...
if($Model->list) {
	...
	$Model->getPropertiesList ( $paramAll );
	unset($paramAll["im_ids"]);
	$im_similar_pri_h = appHtmlClass::partial("immovables/listminiinline", array("Model"=> $Model));
}
?>
