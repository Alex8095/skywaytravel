...
<div class="regionalBlock">
	<div class="regionalTextInput"><span class="rSelected hide"><?php echo $returnStringSelectedItems; ?></span><span class="no-items" style="<?php //echo ($returnStringSelectedItems ? "display:none" : "" );?>">Область</span></div>
