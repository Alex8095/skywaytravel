<?php 
	...
	foreach ($Data as $key => $value) {
		$arr[$value["type_im"].$value["type_rs"]] .= sprintf('<a class="index_im_link" alt="%s" title="%s" href="/%s/%s/?%s_%s=%s">%s</a>', $value["il_title"], $value["il_title"], $value["type_im"], $value["type_rs"], $value["dict_id"], $value["type_reg"], $value["il_name"], $value["il_name"]);
	}
?>
