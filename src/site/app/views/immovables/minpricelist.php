...
<?php global $arWords; ?>
<?php if($Model->list):?>
	<h3 class="title-page-min"><?php echo getLangString("ImDivListHeaderHot")?></h3>
	<div id="bannerImmovablesBlock" class="banner-block">
		<div class="navigation">
			<a href="" title="<?php echo getLangString("ImLinkFlat")?>" class="flat active"><?php echo getLangString("ImLinkFlat")?></a>
			<a href="" title="<?php echo getLangString("ImLinkCommercial")?>" class="commercial"><?php echo getLangString("ImLinkCommercial")?></a>
			<a href="" title="<?php echo getLangString("ImLinkHome")?>" class="home"><?php echo getLangString("ImLinkHome")?></a>
			<a href="" title="<?php echo getLangString("ImLinkLand")?>" class="land"><?php echo getLangString("ImLinkLand")?></a>
			<div class="clear"></div>
		</div>
		<div class="clear"></div>
		<div class="list">
